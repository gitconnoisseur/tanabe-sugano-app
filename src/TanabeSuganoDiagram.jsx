...
const configs = {
  ...
  'd7': { terms: [
    ...
    { label: '2E(G)', allowedStart: 21.29, labelPosX: 15, labelAdjustX: 0, labelAdjustY: -15, allowed: true, color: 'crimson', fn: (x) => x <= 21.29 ? 17.89 + 0.4470*x -0.2604*x**2 +0.02312*x**3 -0.0009743*x**4 +0.00001557*x**5 : 0 },
